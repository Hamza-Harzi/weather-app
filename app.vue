...
//   () =>
//     `https://api.openweathermap.org/data/2.5/weather?q=${search.value}&units=metric&appid=957ae1209925fcd33d53ee8c813ab383`
// );
...
<template>
  ...
  <!-- <div class="p-10">
    ...
    <button class="mt-5 bg-sky-400 px-10 w-50 text-white h-10">Go Back</button>
  </div> -->
</template>
